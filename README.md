...
**$\color{lightred}{\textsf{Snap of dashboard 1: data check and churn reason}}$**
...
**$\color{lightred}{\textsf{Snap of dashboard 2: Churn Factors}}$**
...
**$\color{lightred}{\textsf{Snap of dashboard 3: Churn based on International Calls & Unlimited Plans}}$**
...
**$\color{lightred}{\textsf{Snap of dashboard 4: Contract Type & Payment Method}}$**
...
**$\color{lightred}{\textsf{Snap of dashboard 5: Customer Service}}$**
