...
**$\color{blue}{\textsf{Snap of dashboard 1: data check and churn reason}}$**
...
**$\color{blue}{\textsf{Snap of dashboard 2: Churn Factors}}$**
...
**$\color{blue}{\textsf{Snap of dashboard 3: Churn based on International Calls and Unlimited Plans}}$**
...
**$\color{blue}{\textsf{Snap of dashboard 4: Contract Type and Payment Method}}$**
...
**$\color{blue}{\textsf{Snap of dashboard 5: Customer Service}}$**
